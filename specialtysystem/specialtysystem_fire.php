...
function specialtysystem_fire_getmoduleinfo(){
	$info = array(
		"name" => "Specialty System - Zanpaktou Fire Techniques",
...
function specialtysystem_fire_feats() {
	global $session;
...
function specialtysystem_fire_fightnav(){
	...
	$zan=get_zanpakutou();
	if ($zan->get_raw_type()!=3) return;
	
	$setheadline=0;
	if ($uses > 0) {

		$feats=specialtysystem_fire_feats();
